    ...
    def detect(self, area, frame):
        ...
        if len(class_ids) != 0:
            for i in indices:
                ...
                if result >= 0: #### only detecting the ones insode ROI
                
                    track_data = ([box[0], box[1], box[2], box[3]], confidence, class_ids[i])
                    # print('box: ', boxes)
                    boxes.append(track_data)
