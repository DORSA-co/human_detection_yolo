...
int main(int argc, char** argv)
{
    ...
    const std::string modelName = "Yolov4-tiny";//parser.get<String>("@alias");
    ...
    std::string modelPath = "yolov4-tiny.weights";//findFile(parser.get<String>("model"));
    std::string configPath = "yolov4-tiny.cfg";//findFile(parser.get<String>("config"));
    printf("here");
    // Open file with classes names.
    if (parser.has("classes"))
    {
        std::string file = "classes.txt";//parser.get<String>("classes");
